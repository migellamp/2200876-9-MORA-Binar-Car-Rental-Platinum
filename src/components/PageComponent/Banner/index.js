        ...
        <div className="row container-isi-banner">
            <div className="col banner-page container-text">
                <div className="text-mobil">
                    ...
                    }} >Selamat datang di Binar Car Rental. Kami menyediakan mobil kualitas terbaik dengan harga terjangkau. Selalu siap melayani kebutuhanmu untuk sewa mobil selama 24 jam.  </h6>
                    <div id="button-container-banner">
                        <button  onClick={()=>{
                            return navigate('/search')
                        }} className="sewa-button">Mulai Sewa Mobil</button>
                    </div>
                </div>
            </div>
