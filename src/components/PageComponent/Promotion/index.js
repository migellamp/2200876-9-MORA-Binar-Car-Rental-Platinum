    ...
    <div className="row container-promosi" id="bannerSection">
        ...
        <div className="col text-our-service">
            <div className="container-our-service mb-5">
                <h2 style={{marginBottom:32}}>Best Car Rental for any kind of trip in Surabaya!</h2>
                <h6>Sewa mobil di (Lokasimu) bersama Binar Car Rental jaminan harga lebih murah dibandingkan yang lain, 
