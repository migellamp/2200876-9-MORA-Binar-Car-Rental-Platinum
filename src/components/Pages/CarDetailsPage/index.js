    ...
    return (
        <>
            ...
            <div className="form mb-5">
                <div className="form-container container-form-car-details" style={{top: 195, height:130, paddingTop:20}}>
                <h6 className="pencarianmu-text">Pencarianmu</h6>
                    <div className="form-wrapper wrapper-form-car-details">
                        <SearchFormInput labelName="Nama Mobil" defaultValue={carId.name} id="car-select" disabled widthStyle="237px"/>
                        <SelectFormInput labelName="Kategori" arrayList={categoryList} id="category-select" disabled  widthStyle="237px"/>
                        <SelectFormInput labelName="Harga" arrayList={priceList} id="price-select" disabled  widthStyle="237px"/>
                        <SelectFormInput labelName="Status" arrayList={statusList} id="status-select" disabled  widthStyle="237px"/>
                    </div>
                </div>
            </div>
            ...
            <div className="container-details-car">
                ...
                <div className="wrapper-info-car mt-5">
                    <img className="car-details-pic mb-4" id="img-car-detail" src={carId.image} alt="" />
                    <h6>{carId.name}</h6>
                    <p className="category-detail-cars"><img src={userIcon} alt="" />{category}</p>
